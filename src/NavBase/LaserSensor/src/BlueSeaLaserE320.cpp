   ...
   // std::cout<<"msgtype  "<<msgtype<<std::endl;
    ...
    case 1:
    {
        ...
        if (pointdata->type == FRAMEDATA)
        {
             ...
             int startIndex = g_bLaserInvered ? pointdata->framedata.data.size() - 1 : 0;
             int endIndex = g_bLaserInvered ? -1 : pointdata->framedata.data.size();
             int step = g_bLaserInvered ? -1 : 1;
            ...
            // cout << "now is LDS_E320_S blueSeaLaser, LaserInvered:" << m_bLaserInvered << endl;
    ...
    CRangeScanner(fAngRes, fStartAng, fEndAng,LDS_E320_S)
{
    ...
    g_bLaserInvered = cParam->m_bLaserInverted;
